...
- **[DEPLOY.md](DEPLOY.md)** - Подробная инструкция по деплою на сервер (рекомендуется начать отсюда!)
- **[CONFIG.md](CONFIG.md)** - Как настроить меню, изменить ссылки и добавить новые разделы
